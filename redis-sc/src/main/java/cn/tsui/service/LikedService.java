...
public interface LikedService {
     ...
     * @return
     */
    List<UserLike> getLikedListByLikedUserId(String likedUserId, Pageable pageable);
     ...
     * @return
     */
    List<UserLike> getLikedListByLikedPostId(String likedPostId, Pageable pageable);
